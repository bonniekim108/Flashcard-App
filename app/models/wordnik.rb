class Wordnik
  ...
  query = {api_key: "a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5", limit: 3, 
   ...
   def self.get_related_words(word)
     query = {api_key: "a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5", limitPerRelationshipType: 2, relationshipTypes: "synonym"}
